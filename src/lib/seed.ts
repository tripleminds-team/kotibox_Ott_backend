...
<<<<<<< HEAD
    ...
    { key: 'new-releases',       title: 'New Releases',           contentType: 'movie', filter: { isNewContent: true },          sortBy: { createdAt: -1 }, limit: 10, position: 4,  isActive: true, layout: 'horizontal' },
    { key: 'top-rated-movies',   title: 'Top Rated Movies',       contentType: 'movie', sortBy: { imdbRating: -1 },              limit: 10, position: 5,  isActive: true, layout: 'horizontal' },
    { key: 'action-hits',        title: 'Action Hits',            contentType: 'movie', filter: { sections: 'action-hits' },     sortBy: { views: -1 },     limit: 10, position: 6,  isActive: true, layout: 'horizontal' },
    { key: 'romance-movies',     title: 'Romance Movies',         contentType: 'movie', filter: { sections: 'romance-movies' },  sortBy: { views: -1 },     limit: 10, position: 7,  isActive: true, layout: 'horizontal' },
    { key: 'thriller-zone',      title: 'Thriller Zone',          contentType: 'movie', filter: { sections: 'thriller-zone' },   sortBy: { views: -1 },     limit: 10, position: 8,  isActive: true, layout: 'horizontal' },
    { key: 'sci-fi-universe',    title: 'Sci-Fi Universe',        contentType: 'movie', filter: { sections: 'sci-fi-universe' }, sortBy: { views: -1 },     limit: 10, position: 9,  isActive: true, layout: 'horizontal' },
    { key: 'crime-movies',       title: 'Crime Movies',           contentType: 'movie', filter: { sections: 'crime-movies' },    sortBy: { views: -1 },     limit: 10, position: 10, isActive: true, layout: 'horizontal' },
    { key: 'comedy-time',        title: 'Comedy Time',            contentType: 'movie', filter: { sections: 'comedy-time' },     sortBy: { views: -1 },     limit: 10, position: 11, isActive: true, layout: 'horizontal' },
    { key: 'the-last-heist',     title: 'The Last Heist',         contentType: 'movie', filter: { sections: 'the-last-heist' },  sortBy: { createdAt: -1 }, limit: 10, position: 12, isActive: true, layout: 'horizontal' },
    { key: 'blockbusters',       title: 'Blockbusters',           contentType: 'movie', filter: { sections: 'blockbusters' },    sortBy: { views: -1 },     limit: 10, position: 13, isActive: true, layout: 'horizontal' },
